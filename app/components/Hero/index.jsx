...
export default function Hero() {
  return (
    <div className="w-full md:h-screen h-[89vh] overflow-hidden relative bg-black">
      ...
      {/* Hero Title */}
      <div className="absolute md:top-40 top-44 w-full text-center md:z-30 z-10">
        <h2 className="borel md:text-base text-sm text-white">Hello There —</h2>
        <h2 className="text-white xl:text-3xl lg:text-3xl md:text-2xl text-xl font-bold tracking-wide bruno">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute top-0 left-10 md:w-72 w-40 h-40 md:h-72 md:bg-purple-500/40 bg-purple-600/90  rounded-full blur-[100px] animate-spin" />
        <div className="absolute bottom-10 right-20 md:w-96 md:h-96 w-32 h-32 md:bg-purple-500/40 bg-purple-500/60  rounded-full blur-[120px] animate-spin delay-1000" />
      ...
      {/* Bottom Text */}
      <div className="absolute md:bottom-10 bottom-8 w-full text-center md:z-30 z-10">
