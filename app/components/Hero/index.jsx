...
export default function Hero() {
  ...
  return (
    <div className="w-full md:h-screen h-[89vh] overflow-hidden relative bg-black">
      ...
      {/* Hero Title */}
      <div className="absolute md:top-60 top-64  w-full text-center md:z-30 z-10">
        ...
        <h2 className="text-white xl:text-4xl lg:text-3xl md:text-2xl text-xl font-bold tracking-wide bruno">
          You&apos;ve Entered <br /> a Creative Dimension
        </h2>
        <GlassButtonDemo />
      </div>
      ...
      /> */}
      <div className="absolute md:top-40 top-56 inset-0 z-10">
        <Hero2 />
      </div>

      {/* Bottom Text */}
      <div className="absolute hidden md:bottom-10 bottom-20 w-full text-center md:z-30 z-10">
