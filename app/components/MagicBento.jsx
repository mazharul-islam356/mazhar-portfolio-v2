...
const BentoCardGrid = ({ children, gridRef }) => (
  <div
    className="bento-section grid grid-cols-2 gap-5 p-3 max-w-6xl mx-auto select-none relative"
        ...
        {`
          ...
          .card::before {
            ...
            background: radial-gradient(
              ...
              rgba(132, 0, 255, calc(var(--glow-intensity, 0) * 0.3)) 0%,
              rgba(132, 0, 255, calc(var(--glow-intensity, 0) * 0.15)) 25%,
              transparent 70%
            );
            pointer-events: none;
            opacity: 1;
          ...
          .card:hover {
            ...
            box-shadow: 0 0 30px rgba(132, 0, 255, 0.3), 0 0 60px rgba(132, 0, 255, 0.15);
          }
